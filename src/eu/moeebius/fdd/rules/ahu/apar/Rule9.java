...
/**
 * Implementation of Rule #9 of the APAR rule set: Outside air temperature too high for mechanical cooling with 100% outside air.
 * @author Georgios D. Kontes
 */
public class Rule9 implements AparInterface {

	private String name = "Rule9";
	...
	/**
	 * Instantiates Rule #9 of the APAR rule set
	 */
	public Rule9() {}
	 ...
	 */
	public Rule9(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule9(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #9 of APAR as a static function.

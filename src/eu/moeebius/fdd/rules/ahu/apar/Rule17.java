...
/**
 * Implementation of Rule #17 of the APAR rule set: Supply air temperature should be lower compared to the return air temperature.
 * @author Georgios D. Kontes
 */
public class Rule17 implements AparInterface {

	private String name = "Rule17";
	...
	/**
	 * Instantiates Rule #17 of the APAR rule set
	 */
	public Rule17() {}
	 ...
	 */
	public Rule17(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule17(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #17 of APAR as a static function.

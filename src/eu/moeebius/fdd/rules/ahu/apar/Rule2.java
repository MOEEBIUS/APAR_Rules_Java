...
/**
 * Implementation of Rule #1 of the APAR rule set: Outdoor air fraction too low or too high.
 * @author Georgios D. Kontes
 */
public class Rule2 implements AparInterface {

	private String name = "Rule2";
	...
	/**
	 * Instantiates Rule #2 of the APAR rule set
	 */
	public Rule2() {}
	/**
	 * Instantiates Rule #2 of the APAR rule set
	 ...
	 */
	public Rule2(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule2(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	@Override
	public double apply() {
		double[] tra = inputs.getColumn(0);
		double[] toa = inputs.getColumn(1);
		double[] tma = inputs.getColumn(2);
	...
	/**
	 * Calculation of Rule #2 of APAR as a static function.

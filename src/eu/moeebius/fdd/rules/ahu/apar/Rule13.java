...
/**
 * Implementation of Rule #13 of the APAR rule set: Cooling coil valve saturated fully open and persistent supply air temperature error exists.
 * @author Georgios D. Kontes
 */
public class Rule13 implements AparInterface {

	private String name = "Rule13";
	...
	/**
	 * Instantiates Rule #13 of the APAR rule set
	 */
	public Rule13() {}
	 ...
	 */
	public Rule13(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule13(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #13 of APAR as a static function.

...
/**
 * Implementation of Rule #16 of the APAR rule set: Supply air temperature should be lower compared to the mixed air temperature.
 * @author Georgios D. Kontes
 */
public class Rule16 implements AparInterface {

	private String name = "Rule16";
	...
	/**
	 * Instantiates Rule #16 of the APAR rule set
	 */
	public Rule16() {}
	 ...
	 */
	public Rule16(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule16(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #16 of APAR as a static function.

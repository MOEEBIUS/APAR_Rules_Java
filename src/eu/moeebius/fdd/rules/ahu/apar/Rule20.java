...
/**
 * Implementation of Rule #20 of the APAR rule set: Cooling coil valve saturated fully open, if cooling load increases supply air temperature will drift from setpoint.
 * @author Georgios D. Kontes
 */
public class Rule20 implements AparInterface {

	private String name = "Rule20";
	...
	/**
	 * Instantiates Rule #20 of the APAR rule set
	 */
	public Rule20() {}
	 ...
	 */
	public Rule20(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule20(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #20 of APAR as a static function.

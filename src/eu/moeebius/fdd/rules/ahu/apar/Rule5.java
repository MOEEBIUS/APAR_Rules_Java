...
/**
 * Implementation of Rule #5 of the APAR rule set: Outside air temperature too warm for cooling with outside air.
 * @author Georgios D. Kontes
 */
public class Rule5 implements AparInterface {

	private String name = "Rule5";
	...
	/**
	 * Instantiates Rule #5 of the APAR rule set
	 */
	public Rule5() {}

	/**
	 * Instantiates Rule #5 of the APAR rule set
	 * @param inputs		The inputs of the rule. These are: 1) the operation mode; 2) the outdoor air temperature; 3) the supply air temperature setpoint.
	 */
	public Rule5(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule5(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #5 of APAR as a static function.

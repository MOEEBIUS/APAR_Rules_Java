...
/**
 * Implementation of Rule #6 of the APAR rule set: Supply air temperature should be greater compared to the return air temperature.
 * @author Georgios D. Kontes
 */
public class Rule6 implements AparInterface {

	private String name = "Rule6";
	...
	/**
	 * Instantiates Rule #6 of the APAR rule set
	 */
	public Rule6() {}
	 ...
	 */
	public Rule6(RealMatrix inputs) {
		this.inputs = inputs;
	}
	 ...
	 */
	public Rule6(RealMatrix inputs, RealMatrix parameters) {
		this.inputs = inputs;
	...
	/**
	 * Calculation of Rule #6 of APAR as a static function.
